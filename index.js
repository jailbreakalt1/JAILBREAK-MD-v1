...
const ownerNumber = ['263717456159']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("jailbreak~", '');
...
console.log("CONNECTING JAILBREAK-MD-V1 🧬...");
...
let up = `*╭──────────────●●►*
> *➺ JAILBREAK-MD-V1 ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ GET ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ RYAN✅*
