...
async (conn,mek, m, { from, body, isGroup, isAdmins, isBotAdmins, reply, sender }) => {
    try {
        ...
        const badWords = ["wtf", "mia", "dick","pussy","fucking","mhata","mukosho","mudhidhi","dako","duzvi","matuvi","kushata","mahure","hure","cock","dko","mutuzi","pornograph","porn","porno","xxx","fuck","sex","huththa","pakaya","ponnaya","hutto"]
